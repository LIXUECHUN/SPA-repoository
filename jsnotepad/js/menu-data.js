  ...
  },
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        enabled: true,
        handler: function () {
          console.log('使用 Bing 搜索 menu clicked!');
        }
      },
      {
        title: '查找(F)...',
      ...
      },
      {
        ...
        enabled: true,
        handler: function () {
          console.log('时间/日期(D) menu clicked!');
        }
      },
    ],
    width: '218px',
    ...
    menuItems: [
      {
        ...
        enabled: true,
        handler: function () {
          console.log('自动换行(W) menu clicked!');
        }
      },
      {
        title: '字体(F)...',
        shortcut: '',
        enabled: true,
        handler: dlgFont.openfontbox.bind(dlgFont)
      }
    ],
    width: '156px',
    left:'106px'
    ...
    menuItems: [
      {
        ...
        enabled: true,
        handler: function () {
          console.log('状态栏(S) menu clicked!');
        }
      }
    ],
    width: '138px',
  ...
  },
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        enabled: true,
        handler: function () {
          console.log('关于记事本(A) menu clicked!');
        }
      },
    ],
    width: '166px',
...
var $menubar = menubar.show(menuData);
$app.append($menubar);